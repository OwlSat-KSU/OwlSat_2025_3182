    ...
    def initUI(self):
        ...
        for status in statuses:
                ...
                # Set up each detail label and add to the idle layout
                    ...
                    idle_layout.addLayout(button_layout)
                    left_panel.addWidget(mission_tabs)

                elif status == "READY":
                    Ready_layout = QVBoxLayout()
                    tab.setLayout(Ready_layout)

                    command_details_header = QLabel("Command Details:")
                    command_details_header.setFont(QFont("Arial", 10, QFont.Weight.Bold))
                    command_details_header.setAlignment(Qt.AlignmentFlag.AlignCenter)
                    Ready_layout.addWidget(command_details_header)
                ...
                # Set up each detail label and add to the idle layout
                    ...
                    for label in details_labels:
                        label.setFont(QFont("Arial", 9))
                        label.setAlignment(Qt.AlignmentFlag.AlignLeft)
                        Ready_layout.addWidget(label)

                    tab.setLayout(Ready_layout)
                    mission_tabs.addTab(tab, status)
                elif status == "ASCENDING":
                    Ascending_layout = QVBoxLayout()
                    tab.setLayout(Ascending_layout)

                    command_details_header = QLabel("Command Details:")
                    command_details_header.setFont(QFont("Arial", 10, QFont.Weight.Bold))
                    command_details_header.setAlignment(Qt.AlignmentFlag.AlignCenter)
                    Ascending_layout.addWidget(command_details_header)
                ...
                # Set up each detail label and add to the idle layout
                    ...
                    for label in details_labels:
                        label.setFont(QFont("Arial", 9))
                        label.setAlignment(Qt.AlignmentFlag.AlignLeft)
                        Ascending_layout.addWidget(label)

                    tab.setLayout(Ascending_layout)
                    mission_tabs.addTab(tab, status)

                elif status == "DESCENDING":
                    Descending_layout = QVBoxLayout()
                    tab.setLayout(Descending_layout)

                    command_details_header = QLabel("Command Details:")
                    command_details_header.setFont(QFont("Arial", 10, QFont.Weight.Bold))
                    command_details_header.setAlignment(Qt.AlignmentFlag.AlignCenter)
                    Descending_layout.addWidget(command_details_header)
                ...
                # Set up each detail label and add to the idle layout
                    ...
                    for label in details_labels:
                        label.setFont(QFont("Arial", 9))
                        label.setAlignment(Qt.AlignmentFlag.AlignLeft)
                        Descending_layout.addWidget(label)

                    tab.setLayout(Descending_layout)
                    mission_tabs.addTab(tab, status)
                    
                elif status =="RETRIEVAL":
                    Retrieval_layout = QVBoxLayout()
                    tab.setLayout(Retrieval_layout)

                    command_details_header = QLabel("Command Details:")
                    command_details_header.setFont(QFont("Arial", 10, QFont.Weight.Bold))
                    command_details_header.setAlignment(Qt.AlignmentFlag.AlignCenter)
                    Retrieval_layout.addWidget(command_details_header)
                ...
                # Set up each detail label and add to the idle layout
                    ...
                    for label in details_labels:
                        label.setFont(QFont("Arial", 9))
                        label.setAlignment(Qt.AlignmentFlag.AlignLeft)
                        Retrieval_layout.addWidget(label)
