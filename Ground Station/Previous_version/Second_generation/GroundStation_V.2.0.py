...
class MechanismWindow(QWidget):
    def __init__(self, controller):
        ...
        self.pinRelease_btn_state = False
        self.pinRelase_btn_2.clicked.connect(self.toggle_pin_release)
    ...
    def toggle_boom(self):
        if self.Booms_btn_State:
            self.controller.send_command("CMD,3182,MEC,BoomStick,ON,120")
            #self.pinRelease_btn.setText("Pin Release: OFF")
        else:
...
class PlotWindow(QWidget):
    def __init__(self, controller):
        ...
        self.setGeometry(100, 20, 1200, 1000)
...
class SimulationWindow(QWidget):
    def __init__(self, controller):
        ...
        self.transmit_interval = 2000  # Transmit every 1 second
